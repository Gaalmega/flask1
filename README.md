...
- 🎯 Entry points to execute your program using `python -m <flask1>` or `$ flask1` with basic CLI argument parsing.
...
---
# flask1 Flask Application

Awesome flask1 created by Gaalmega
...
```bash
git clone https://github.com/Gaalmega/flask1 flask1
cd flask1
make install
```
...
```bash
flask1 create-db   # run once
flask1 populate-db  # run once (optional)
flask1 add-user -u admin -p 1234  # ads a user
flask1 run
```
