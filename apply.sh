...
original_author="Gaalmega"
original_name="flask1"
original_urlname="flask1"
original_description="Awesome flask1 created by Gaalmega" 
...
then
    ...
    echo "then run 'flask1' or 'python -m flask1'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'flask1' or 'python -m flask1' or 'poetry run flask1'"
fi
